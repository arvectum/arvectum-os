...
| `P6.05` | Platform-gap remediation from first real use | 🟨 Current — L1-L6 PASS; L7 real live run next; real evidence pending | `tracked by subtasks` |
...
7. `P6.05-L7` real exact-attachment live run with truthful `7/7` gate — current / next;
