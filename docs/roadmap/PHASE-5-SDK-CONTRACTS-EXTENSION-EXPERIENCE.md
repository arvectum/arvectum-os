...
- `R13 — Integration Boundary Review` — **current gate after P5.02**. Confirm that tooling expresses RFC-0004 boundaries rather than inventing a second contract system.
